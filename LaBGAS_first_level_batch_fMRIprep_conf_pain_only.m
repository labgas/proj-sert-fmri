...
% end
basedir = 'C:\Users\lukas\Dropbox (Personal)\proj-SERT-fMRI\scripts';
derivdir = 'C:\Users\lukas\Dropbox (Personal)\proj-SERT-fMRI\scripts\testderiv\sub-02\func'; % dir with fMRIprep output, and noise_regs files
rawdir = 'C:\Users\lukas\Dropbox (Personal)\proj-SERT-fMRI\scripts\testraw\sub-02\func'; % dir with raw .nii files, and onsets_ files  
outputdir = 'C:\Users\lukas\Dropbox (Personal)\proj-SERT-fMRI\scripts\testfirstlevel\sub-02'; 
TR = 2;
nr_slices = 36;
nr_task_runs = 3;
conds2model = {'pain'};
...
matlabbatch{3}.spm.stats.con.spmmat(1) = cfg_dep('Model estimation: SPM.mat File', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','spmmat'));
    if strcmpi(basis_set,'can')==1
        ...
        matlabbatch{3}.spm.stats.con.consess{1}.tcon.weights = [ones(1,1) zeros(1,size(noise_neg,2)) ones(1,1) zeros(1,size(noise_neu,2)) ones(1,1)];
        matlabbatch{3}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
        matlabbatch{3}.spm.stats.con.consess{2}.tcon.name = ['pain in negative'];
        matlabbatch{3}.spm.stats.con.consess{2}.tcon.weights = [ones(1,1)]; 
        matlabbatch{3}.spm.stats.con.consess{2}.tcon.sessrep = 'none';
        matlabbatch{3}.spm.stats.con.consess{3}.tcon.name = ['pain in neutral'];
        matlabbatch{3}.spm.stats.con.consess{3}.tcon.weights = [zeros(1,1) zeros(1,size(noise_neg,2)) ones(1,1)]; 
        matlabbatch{3}.spm.stats.con.consess{3}.tcon.sessrep = 'none';
        matlabbatch{3}.spm.stats.con.consess{4}.tcon.name = ['pain in positive'];
        matlabbatch{3}.spm.stats.con.consess{4}.tcon.weights = [zeros(1,1) zeros(1,size(noise_neg,2)) zeros(1,1) zeros(1,size(noise_neu,2)) ones(1,1)]; 
        matlabbatch{3}.spm.stats.con.consess{4}.tcon.sessrep = 'none';
        matlabbatch{3}.spm.stats.con.consess{5}.tcon.name = ['pain in negative vs neutral'];
        matlabbatch{3}.spm.stats.con.consess{5}.tcon.weights = [ones(1,1) zeros(1,size(noise_neg,2)) -ones(1,1)]; 
        matlabbatch{3}.spm.stats.con.consess{5}.tcon.sessrep = 'none';
        matlabbatch{3}.spm.stats.con.consess{6}.tcon.name = ['pain in negative vs positive'];
        matlabbatch{3}.spm.stats.con.consess{6}.tcon.weights = [ones(1,1) zeros(1,size(noise_neg,2)) zeros(1,1) zeros(1,size(noise_neu,2)) -ones(1,1)]; 
        matlabbatch{3}.spm.stats.con.consess{6}.tcon.sessrep = 'none';
        matlabbatch{3}.spm.stats.con.consess{7}.tcon.name = ['pain in neutral vs positive'];
        matlabbatch{3}.spm.stats.con.consess{7}.tcon.weights = [zeros(1,1) zeros(1,size(noise_neg,2)) ones(1,1) zeros(1,size(noise_neu,2)) -ones(1,1)]; 
        matlabbatch{3}.spm.stats.con.consess{7}.tcon.sessrep = 'none';
    elseif strcmpi(basis_set,'derivs')==1
        matlabbatch{3}.spm.stats.con.consess{1}.fcon.name = ['main effect of pain'];
        matlabbatch{3}.spm.stats.con.consess{1}.fcon.weights = [eye(3) zeros(3,size(noise_neg,2)) eye(3) zeros(3,size(noise_neu,2)) eye(3)]; 
        matlabbatch{3}.spm.stats.con.consess{1}.fcon.sessrep = 'none';
        matlabbatch{3}.spm.stats.con.consess{2}.fcon.name = ['pain in negative'];
        matlabbatch{3}.spm.stats.con.consess{2}.fcon.weights = [eye(3)];
        matlabbatch{3}.spm.stats.con.consess{2}.fcon.sessrep = 'none';
        matlabbatch{3}.spm.stats.con.consess{3}.fcon.name = ['pain in neutral'];
        matlabbatch{3}.spm.stats.con.consess{3}.fcon.weights = [zeros(3,3) zeros(3,size(noise_neg,2)) eye(3)]; 
        matlabbatch{3}.spm.stats.con.consess{3}.fcon.sessrep = 'none';
        matlabbatch{3}.spm.stats.con.consess{4}.fcon.name = ['pain in positive'];
        matlabbatch{3}.spm.stats.con.consess{4}.fcon.weights = [zeros(3,3) zeros(3,size(noise_neg,2)) zeros(3,3) zeros(3,size(noise_neu,2)) eye(3)]; 
        ...
        matlabbatch{3}.spm.stats.con.consess{5}.fcon.weights = [eye(3) zeros(3,size(noise_neg,2)) -eye(3)]; 
        ...
        matlabbatch{3}.spm.stats.con.consess{6}.fcon.weights = [eye(3) zeros(3,size(noise_neg,2)) zeros(3,3) zeros(3,size(noise_neu,2)) -eye(3)]; 
        ...
        matlabbatch{3}.spm.stats.con.consess{7}.fcon.weights = [zeros(3,3) zeros(3,size(noise_neg,2)) eye(3) zeros(3,size(noise_neu,2)) -eye(3)]; 
